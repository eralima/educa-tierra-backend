package com.g4.Ecommerce.configuration;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		.description("Projeto integrador - EducaTierra")
		.version("1.0.0")
	...
	private static Contact contact() {
		return new Contact("Equipe Educa Tierra",
		"https://github.com/eralima/educa-tierra-backend",
